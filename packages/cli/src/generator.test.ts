import { ParameterTransform } from '@lsge/pgtyped-runtime';

import { parseSQLFile } from '@lsge/pgtyped-parser';
...
describe('query-to-interface translation', () => {
  [ProcessingMode.SQL, ProcessingMode.TS].forEach((mode) => {
    ...
    `;
      ...
      // Test out imports
      types.use(
        { name: 'PreparedQuery', from: '@lsge/pgtyped-query' },
        TypeScope.Return,
      );
      ...
      const expectedTypes = `import { PreparedQuery } from '@lsge/pgtyped-query';
